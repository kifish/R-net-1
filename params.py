...
class Params():
    ...
    logdir = "./train/train" # 模型checkpoint也在这个目录
    ...
    save_steps = 1000 # Save the model at every x steps
    ...
    vocab_size = 91650 # Number of vocabs in glove.840B.300d.txt + 1 for an unknown token
